...
export const configres = [
  ...
  },
  {
    info: {
      id: "352816",
      name: "Grameen Kulfi",
      cloudinaryImageId: "zorhubneelmwgycwqsll",
      locality: "Sector 21",
      areaName: "Nigdi",
  ...
  },
  {
    info: {
      ...
      cloudinaryImageId: "ntumwjq20y2mwhpumgqd",
      locality: "Sector 25",
      areaName: "Nigdi",
      costForTwo: "₹400 for two",
  ...
  },
  {
    info: {
      ...
      cloudinaryImageId: "a5ed076264a5a08039ac5320db8a58c5",
      locality: "Lokmanya Tilak Road",
      areaName: "Nigdi",
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2023-10-13 01:30:00",
        opened: true,
      },
      badges: {},
      isOpen: true,
  ...
  },
  {
    info: {
      ...
      areaName: "PCMC",
      costForTwo: "₹250 for two",
      cuisines: ["North Indian", "Beverages", "Desserts"],
      avgRating: 4.2,
      feeDetails: {
        restaurantId: "762996",
        fees: [
  ...
  },
  {
    info: {
      id: "39775",
      name: "Hotel Gaarva ( Malhar)",
      cloudinaryImageId: "jrdrva8s1tuqtx3dzdmj",
      locality: "Rameera Tower",
      areaName: "Nigdi",
      costForTwo: "₹450 for two",
      cuisines: [
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2023-10-13 03:45:00",
        opened: true,
      },
      badges: {},
      isOpen: true,
  ...
  },
  {
    info: {
      id: "570131",
      name: "Domino's Pizza",
      cloudinaryImageId: "ytnjnixkgwfpmzikgb0t",
      locality: "Kashmere Gate Metro Station",
      areaName: "Kashmiri Gate",
      costForTwo: "₹400 for two",
      cuisines: ["Pizzas", "Italian", "Pastas", "Desserts"],
      ...
      availability: {
        nextCloseTime: "2023-10-13 00:55:00",
        opened: true,
      },
      badges: {},
      isOpen: true,
  ...
  },
  {
    info: {
      id: "77602",
      name: "Shalimar Biryani & Tava Fry",
      cloudinaryImageId: "d8d0e69b0dec0e6b58d37891107374aa",
      locality: "Sultaniya",
      areaName: "Rander",
      costForTwo: "₹300 for two",
      cuisines: [
  ...
  },
  {
    info: {
      ...
      areaName: "Athwa",
      costForTwo: "₹300 for two",
      cuisines: ["Chinese", "Ice Cream", "Pizzas", "Biryani"],
      avgRating: 4.3,
      feeDetails: {
        restaurantId: "563098",
        fees: [
